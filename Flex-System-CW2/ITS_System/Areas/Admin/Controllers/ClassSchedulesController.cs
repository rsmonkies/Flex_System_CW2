...
namespace ITS_System.Areas.Admin
{
    ...
    public class ClassSchedulesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClassName,Id,DateTime,InstructorId,MaxNumbersOfBooking,RoomId,Status")] ClassSchedule classSchedule, string[] WaitingList, string[] EquipmentList)
        {

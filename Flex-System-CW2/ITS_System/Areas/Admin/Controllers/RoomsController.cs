...
namespace ITS_System.Areas.Admin.Views
{
    ...
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Description,Capacity")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Capacity")] Room room)
        {
            if (id != room.Id)
            {
                return NotFound();
